...
const EXAMPLES = [
  ...
  },
  {
    ...
    title: '3. Feedback Hazards (datapath-level)',
    desc: 'Four isolated lanes, one hazard per lane: RAW feedback through two PIPEs, a combinational NAND LOOP, a WAR feedback into a 2-channel PIPE, and a WAW collision with two PIPEs writing the same XOR pin. The HAZARDS section classifies all four with colour-coded badges and click-to-jump-to-wire. Distinct from program hazards — this is the structural analyzer on the datapath graph.',
    tags: ['pipeline', 'hazard', 'feedback', 'RAW', 'WAR', 'WAW', 'LOOP'],
  ...
  },
  {
    ...
    title: '5. Elastic Pipeline — valid/ready + LIP',

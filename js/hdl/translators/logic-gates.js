...
//   BUF  → buf  g(y, a);
//
// TRIBUF is intentionally NOT here — it produces a tri-state output and
// belongs to the BUS / lowerTriState pass landing in Phase 5.

import { COMPONENT_TYPES } from '../../components/Component.js';
import { registerTranslator } from './index.js';
import { makeInstance, makeRef } from '../ir/types.js';
